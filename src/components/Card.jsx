...
const Card = () => {
  return (
    ...
    <div className='flex'>
    <img src={posterimg} alt="poster" data-testid="movie-poster" />
    </div>
<div className="flex pt-2 pb-1 text-xs text-[#9CA3AF]" data-testid="movie-release-date">USA, 2016 - Current</div>
<div className="flex text-black pt-1 pb-1 text-lg font-sans font-bold" data-testid="movie-title">Stranger Things</div>
