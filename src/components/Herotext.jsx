...
const Herotext = () => {
  return (
    <>
    <div className=" grid grid-cols-2 column w-full h-[90vh] content-center ">
      <div className="text-white flex ml-[8vw] flex-col w-[50%]">
        <h1 className="text-4xl font-semibold pb-5">John Wick 3 : Parabellum</h1>
      ...
      <div className="hero-content font-semibold pb-5 pt-5">
